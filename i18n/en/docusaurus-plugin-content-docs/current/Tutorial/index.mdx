...
TexTransTool is a tool that is [high level atlasing](/docs/Tutorial/AtlasTexture-Tutorial.md) and [intuitive color modification](/docs/Tutorial/SimpleDecal-Tutorial.md)!
